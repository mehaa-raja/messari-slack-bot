...
- CRITICAL: For proper Slack bullet formatting, each bullet point must start with "- " (dash + space) at the very beginning of the line with NO indentation. Each section with bullets must have a blank line after the header before the first bullet.
...
- Notable Events & Listings should be 4–6 bullet points, each starting with "- " (dash space)
- Infrastructure & Ecosystem should also have an emoji header with all items as "- " bullet format
...
Note the blank line after the header before bullets start.
