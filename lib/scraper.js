  ...
  try {
    ...
    const response = await axios.post('https://api.messari.io/ai/openai/chat/completions', {
      messages: [
        {
          role: "system",
          content: "You are a professional crypto news analyst. Provide comprehensive, well-structured daily briefs that include market context, key developments, and their implications. Focus on the most significant stories and trends."
        },
        {
          role: "user",
          content: `Can you give today's (${today}) top Crypto news in a 5 minute read - news brief? Please include the most important stories, market movements, and any significant developments in DeFi, infrastructure, regulations, and major cryptocurrencies. Format it as a professional newsletter.`
        }
      ],
      verbosity: "verbose",
