...
- Only about token price movements without business context
...
- "PRICE_ONLY" if it's only about price changes
...
export async function detectPortfolioMentionsInText(rawContent, portfolioList = PANTERA_PORTFOLIO_COMPANIES) {
  ...
  for (const article of articles) {
    ...
    for (const subject of mainSubjects) {
      ...
      // Skip pattern-based filtering - let AI make all decisions about meaningful business actions
